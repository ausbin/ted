...
# Include variables with names of pre-generated files
ASSETSDIR = assets
include $(ASSETSDIR)/generated.mak
ASSET_OFILES := $(patsubst %,$(ASSETSDIR)/%,$(ASSET_OFILES))
ASSET_DFILES := $(patsubst %.o,%.d,$(ASSET_OFILES))
ASSET_HFILES := $(patsubst %,$(ASSETSDIR)/%,$(ASSET_HFILES))
...
OFILES = main.o myLib.o ted.o level.o luts.o victory.o $(ASSET_OFILES)

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h ted.h level.h luts.h victory.h $(ASSET_HFILES)
...
clean :
	...
	@rm -f *.o *.elf *.gba *.d res/*.o res/*.d $(ASSET_OFILES) $(ASSET_DFILES)
